...
print("Mean,Median and Mode of height is :",height_mean, height_median,height_mode)
print("Mean,Median and Mode of weight is :",weight_mean, weight_median,weight_mode)
...
print("Data for height lies within 1 standard deviation",format(len(height_list_of_data_within_1_std_deviation)*100.0/len(height_list)))
print("Data for height lies within 2 standard deviation",format(len(height_list_of_data_within_2_std_deviation)*100.0/len(height_list)))
print("Data for height lies within 3 standard deviation",format(len(height_list_of_data_within_3_std_deviation)*100.0/len(height_list)))
...
print("Data for weight lies within 1 standard deviation",format(len(weight_list_of_data_within_1_std_deviation)*100.0/len(weight_list)))
print("Data for weight lies within 2 standard deviation",format(len(weight_list_of_data_within_2_std_deviation)*100.0/len(weight_list)))
print("Data for weight lies within 3 standard deviation",format(len(weight_list_of_data_within_3_std_deviation)*100.0/len(weight_list)))
